        ...
        <form action="{{ route('plants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 class="text-lg font-semibold text-blue-900 mb-3">
                    <i class="fas fa-leaf text-blue-600 mr-2"></i>Quick Select: Common Fruits & Vegetables
                </h3>
                <p class="text-sm text-blue-700 mb-3">
                    Select a plant from our common collection to automatically set the care schedule. Perfect for tropical gardening!
                </p>
                <label for="plant_preset" class="block text-sm font-medium text-gray-700 mb-2">Choose a Plant Preset</label>
                <select id="plant_preset" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                    <option value="">-- Select a Plant --</option>
                </select>
                <p class="text-xs text-gray-500 mt-2">
                    <i class="fas fa-info-circle mr-1"></i>This will auto-fill the care schedule below. You can still adjust the values manually.
                </p>
            </div>
